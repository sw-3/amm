...
describe('AMM', () => {
  ...
  describe('Swapping Tokens', () => {
    ...
    it('facilitates swaps', async () => {
      ...
      console.log(`Liquidity Provider Token1 balance Before: ${ethers.utils.formatEther(balance)}\n`)

      balance = await token2.balanceOf(liquidityProvider.address)
      console.log(`Liquidity Provider Token2 balance Before: ${ethers.utils.formatEther(balance)}\n`)
      ...
      balance = await token1.balanceOf(liquidityProvider.address)
      console.log(`Liquidity Provider Token1 balance After: ${ethers.utils.formatEther(balance)}\n`)
